...
class weatherStaticsRepository {
  ...
  Future<List<wheather_Model>> fetchWeatherStatices() async {
    List<wheather_Model> weatherStatics = [];
    ...
    for (int i = 1; i < 5; i++) {
      ...
      var response = await _dio.get('/1360000/TourStnInfoService1/getTourStnVilageFcst1', queryParameters: {
      ...
      items.forEach((element) {
        weatherStatics.add(wheather_Model.fromXml(element));
      });
    }
